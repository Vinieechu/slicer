...
description = "slicepy: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/slicepy/blob/master/README.md

License
=======
``slicepy`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/slicepy"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'slicepy': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
