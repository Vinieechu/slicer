...
# -*- coding: utf-8 -*-
#
# slicepy documentation build configuration file, created by
...
latex_documents = [
  ('index', 'slicepy.tex', 'slicepy Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'slicepy', 'slicepy Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'slicepy', 'slicepy Documentation',
   'Ariel Rokem', 'slicepy', 'One line description of project.',
   'Miscellaneous'),
]
